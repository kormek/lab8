...
// ������������ ��� ����� cookie 
    ...
    // ������� ����� 
    pw.println("<form action='/lab8_new_war_exploded/' method='post'>Введите имя:" +
...
// ����� ������ �������� ����� �����������     
    ...
    if (errorMessage!=null) { 
      ...
      // �������������� ������� �� �������� �������� � ������ 
      response.sendRedirect(response.encodeRedirectURL("/lab8_new_war_exploded/"));
    } 
  } 
...
// �� ��������� ������������� 
  ...
  response.sendRedirect(response.encodeRedirectURL("/lab8_new_war_exploded/view.htm"));
      // ������� null, �.�. ��������� �� ������� ��� 
      return null; 
    } else { 
      // ����������� � ������ ��� ��� ���������� �� ���-�� ������. 
